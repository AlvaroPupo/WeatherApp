...
import com.example.juanalvaropupo.weatherapp.api_calls.dark_sky.DarkSkyApi;
import com.example.juanalvaropupo.weatherapp.api_calls.dark_sky.Weather;
import com.example.juanalvaropupo.weatherapp.api_calls.google.GoogleAddress;
import com.example.juanalvaropupo.weatherapp.api_calls.google.GoogleGeoApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        darkSkyBaseUrl = getString(R.string.darksky_base_url);
        googleApiKey = getString(R.string.google_api_key);
        darkSkyApiKey = getString(R.string.darksky_api_key);
    ...
    private void getLocation(String address) {
        googleGeoApi.getAdress(address, googleApiKey).enqueue(new Callback<GoogleAddress>() {
            @Override
            public void onResponse(Call<GoogleAddress> call, Response<GoogleAddress> response) {
                try {
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(MainActivity.this, "call made no response", Toast.LENGTH_SHORT).show();
                    }
                }catch(Exception e){
        ...
        darkSkyApi.getWeather(darkSkyApiKey, lat, lng).enqueue(new Callback<Weather>() {
            ...
            public void onResponse(Call<Weather> call, Response<Weather> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(MainActivity.this, "weather call made unssucessful", Toast.LENGTH_SHORT).show();
                    }
            }
